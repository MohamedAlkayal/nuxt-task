...
/**
  ...
  *
  * @checksum - a623000431769034cb66c5a6a1a8237bc34a5d5f6066d573f07bc4b442e72c93
  * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=gray,spacing=2,scale=base,inputShadow=shadow-none,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
